...
class GridChecker(Checker[GridCellRepository]):
    def check_correct(self, obj: GridCellRepository) -> bool:
        occurring_numbers = []
    ...
    def check_final(self, obj: GridCellRepository) -> bool:
    ...
    def support(self, obj: any) -> bool:
        return isinstance(obj, GridCellRepository)