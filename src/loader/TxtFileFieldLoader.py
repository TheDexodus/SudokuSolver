...
from src.field.RectangleField import RectangleField
from src.field.RectangleFieldInterface import RectangleFieldInterface
from src.loader.AbstractFileFieldLoader import AbstractFileFieldLoader
...
class TxtFileFieldLoader(AbstractFileFieldLoader):
    ...
    def load(self) -> RectangleFieldInterface:
